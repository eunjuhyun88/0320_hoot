<script lang="ts">
  export let type: "sparkle" | "grid" | "chart" | "globe" | "protocol" | "arrow" | "ontology" = "sparkle";
  export let size: number = 16;
</script>

<svg width={size} height={size} viewBox="0 0 16 16" fill="none" class="px-icon" shape-rendering="crispEdges">
  {#if type === "sparkle"}
