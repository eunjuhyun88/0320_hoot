...
| runtime working memory | `.agent-context/checkpoints/`, `.agent-context/briefs/`, `.agent-context/handoffs/`, `.agent-context/state/` |
...
- Provisional checkpoints do not satisfy push, handoff, or release.
- Handoff/release must happen from a clean worktree with compacted state.
