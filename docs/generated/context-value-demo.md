...
- You start from about `4310` tokens instead of `24122` across the broader docs set.
- You can discover `3` surfaces, `3` reusable agents, and `3` reusable tools without replaying chat history.
- Ambiguous tasks can fall back to retrieval over `265` indexed chunks.
...
| --- | --- | --- |
| Small start bundle | PASS | 4310 tokens vs 24122 tokens across all docs (82.1% smaller) |
| Discovery works without chat memory | PASS | 3 surfaces, 3 agents, 3 tools |
| Ambiguity has a retrieval escape hatch | PASS | 265 retrieval chunks across 34 sources |
