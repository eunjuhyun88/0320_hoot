...
- You start from about `4503` tokens instead of `25170` across the broader docs set.
- You can discover `3` surfaces, `3` reusable agents, and `3` reusable tools without replaying chat history.
- Ambiguous tasks can fall back to retrieval over `281` indexed chunks.
...
| --- | --- | --- |
| Small start bundle | PASS | 4503 tokens vs 25170 tokens across all docs (82.1% smaller) |
| Discovery works without chat memory | PASS | 3 surfaces, 3 agents, 3 tools |
| Ambiguity has a retrieval escape hatch | PASS | 281 retrieval chunks across 34 sources |
